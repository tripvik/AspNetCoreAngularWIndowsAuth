...
- Create Angular project with ng: `ng new aspnetcoreangularwindowsauth.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`aspnetcoreangularwindowsauth.client.esproj`).
